...
class Album extends CI_Controller
{
    ...
    public function edit($albumid = null)
    {
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($_FILES['cover']['name'] != '') {
                ...
                if ($album->cover != '' && file_exists('./assets/image_cover/' . $album->cover)) {
                    unlink('./assets/image_cover/' . $album->cover);
                }
                // Upload gambar baru
                $data['cover'] = $this->upload_cover();
            } else {
    ...
    {
        $config['upload_path'] = './assets/image_cover/';
