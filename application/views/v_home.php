      ...
      <div class="row">
        ...
        <div class="col-lg-5 offset-lg-1">
          <div class="owl-banner owl-carousel">
            <div class="item">
              <img src="<?= base_url() ?>assets/frontend/images/banner-01.png" alt="">
            </div>
            <div class="item">
              <img src="<?= base_url() ?>assets/frontend/images/banner-02.png" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="section-heading">
            ...
            <h2><em>Rekomendasi</em> Untuk Anda.</h2>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="filters">
            ...
            <div class="col-lg-6 currently-market-item all msc">
              <div class="item">
                <div class="left-image">
                  <img src="<?= base_url() ?>assets/frontend/images/market-01.jpg" alt="" style="border-radius: 20px; min-width: 195px;">
                </div>
                <div class="right-content">
                  <h4>Music Art Super Item</h4>
                  <span class="author">
                    <img src="<?= base_url() ?>assets/frontend/images/author.jpg" alt="" style="max-width: 50px; border-radius: 50%;">
